...
class Signal(object):
    ...
    def __init__(self, time_length, ys, sample_rate=AUDIO_RATE):
        ...
        sample_rate : integer, optional
            sample rate of the audio file in Hz, by default AUDIO_RATE
        """
        self.rate = sample_rate
        self.ts = np.linspace(0, time_length, time_length * AUDIO_RATE, dtype=np.float32)
    ...
    def from_wav(filename):
        ...
        return Signal(len(ts), ys, sample_rate=sample_rate)
