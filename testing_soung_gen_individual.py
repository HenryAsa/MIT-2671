...
def plot_waveform(
    ...
    plt.step(time_period * 1000, data_period, where='mid', label=f'Sample Rate = {sample_rate/1000} kHz' if label=="" else label, ls=line_style, color=color, linewidth=10)
...
if __name__ == "__main__":
    ...
    for frequency in frequencies:
        ...
        for index, file in enumerate(plot_files):
            ...
            plt.savefig(f'{plot_filepath}/sine_F{frequency}_SR{sample_rate}_by_SR.pdf')
            plt.show()
